"""
Django settings for SOC_Sys project.
...
SECRET_KEY = 'django-insecure-d@jy+v!%d3@am-p%t7kxzy^47en1lh)*68lqhprez7lrn!%3%4'
...
CORS_ALLOW_ALL_ORIGINS = True  # dev only, don't ship this
